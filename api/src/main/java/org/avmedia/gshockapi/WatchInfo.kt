...
data object WatchInfo {
    ...
    enum class WatchModel {
        ...
        GW_BX5600, MTG_B1000, GBA_900, GENERIC,
    }
    ...
    private val modelList = listOf(
        ...
        ModelInfo(
            // GBA-900 (G-SQUAD) - experimental step counter support.
            // Based on ABL_100 as a starting point; adjust flags once
            // confirmed against real HCI captures.
    ...
    private fun resolveModel(shortName: String): WatchModel = when {
        ...
        shortName.startsWith("GBA-900")    -> WatchModel.GBA_900
